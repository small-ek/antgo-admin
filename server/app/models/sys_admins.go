...
type SysAdmins struct { 
    ...
    Salt string `gorm:"column:salt" json:"salt" form:"salt" comment:"盐"`//盐
    ...
    Status int `gorm:"column:status" json:"status" form:"status" comment:"状态:1=成功;2=失败"`//状态:1=成功;2=失败
...
func (SysAdmins) TableName() string {
	return "antgo.sys_admins"
}